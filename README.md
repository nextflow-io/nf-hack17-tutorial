...
Singularity images are created using a `Singularity` in  similar manner to Docker, 
...
apt-get update && apt-get install -y curl cowsay 
...
sudo singularity bootstrap my-image.img Sing 
```
